...
const FarmCard: React.FC<FarmCardProps> = ({ farm, removed, cakePrice, bnbPrice, ethPrice, account }) => {
  ...
  const earnLabel = farm.dual ? farm.dual.earnLabel : 'KANDY'
  ...
  return (
    <FCard>
      {farm.tokenSymbol === 'KANDY' && <StyledCardAccent />}
      <CardHeading
        lpLabel={lpLabel}
      ...
      <ExpandingWrapper expanded={showExpandableSection}>
        <DetailsSection
          removed={removed}
          bscScanAddress={`https://explorer.kcc.io/en/address/${farm.lpAddresses[process.env.REACT_APP_CHAIN_ID]}`}
